...
//defines
#define SSID_REDE     "qual e a senha"  //coloque aqui o nome da rede que se deseja conectar
#define SENHA_REDE    "meadota123"  //coloque aqui a senha da rede que se deseja conectar
...
#define TOPICO_SUBSCRIBE "IoTEnvia"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "IoTRecebe"    //tópico MQTT de envio de informações para Broker
...
const char* BROKER_MQTT = "192.168.0.9"; //URL do broker MQTT que se deseja utilizar
